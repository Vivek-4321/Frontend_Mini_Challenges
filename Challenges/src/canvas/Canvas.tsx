...
//       setIsDrawing(true);
//     }
//   }, [zoom, tool, color, size, setCurrentShape]);
...
//       }
//     }
//   }, [isDrawing, zoom, tool, currentShape]);
...
//       container.style.width = `${canvas.width * newZoom}px`;
//       container.style.height = `${canvas.height * newZoom}px`;
//     }
//   }, []);

//   return (
//     <div ref={containerRef} className="canvas-container" style={{ position: 'relative', overflow: 'auto' }}>
//       <canvas
//         ref={canvasRef}
